---
title: MacPorts 2.12.6 now available
slug: macports-2126-now-available
date: 2026-08-25 15:32:21
---

The MacPorts Project is pleased to announce the release of version
2.12.6. This is a bugfix release with small changes only. See the
...
macOS 26 Tahoe and all older releases back to Mac OS X 10.5 Leopard. The
...
38C7 BEED 648D CC82 A2FA  341A 87A7 C502 C181 5ACB

Note that this is a new key, and it has been signed with the previous one.

The MacPorts Port Managers

[1]: <https://github.com/macports/macports-base/blob/release-2.12/ChangeLog>
[2]: <https://www.macports.org/install.php>
[3]: <https://github.com/macports/macports-base/releases/tag/v2.12.6>
